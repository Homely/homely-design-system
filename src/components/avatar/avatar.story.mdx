...
<Preview withToolbar>
  <Story name="standard">
    <Avatar
      size="large"
      username="Michael Soutar"
      src="https://avatars1.githubusercontent.com/u/905265"
    />
  </Story>
</Preview>
...
<Story name="initials">
  <div>
    <Avatar username="Michael Soutar" />
    <Avatar username="Michael Ottey" />
    <Avatar username="Morgan Jackson" />
  </div>
</Story>
...
<Story name="knobs" parameters={{ decorators: [withKnobs] }}>
  <Avatar
    ...
    username="Homely"
    src="https://avatars1.githubusercontent.com/u/5516316?s=200&v=4"
  />
</Story>
